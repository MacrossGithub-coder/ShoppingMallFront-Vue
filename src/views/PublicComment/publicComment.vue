<template>
  <div class="bgView">
    ...
    <div class="bgScored">
      <div>
        <img  class="headerImg" :src="$route.params.order_detail.commodity_img">
        <div class="grade-box">
    ...
    <div class="line"></div>
    <div class="inputText">
      <textarea v-bind:maxlength="Surplus" @input="descArea" v-model="inputText" name="abstract" id="abstract" placeholder="亲！给个五星好评呗。"></textarea>
      <div class="selectPic">
...
var starOffImg = 'http://112.124.18.163/static/macross_shopping/img/vue/Images/star02%402x.png'
var starOnImg = 'http://112.124.18.163/static/macross_shopping/img/vue/Images/star%402x.png'
export default {
  data: function () {
    return {
      scoreInfo: '很满意',
